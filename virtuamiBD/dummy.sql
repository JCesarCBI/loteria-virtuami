...
#Test audio rima
UPDATE loteriadb.frase SET audioOGG = '/media/audio/02_diablo.ogg' WHERE idCarta = '2';
UPDATE loteriadb.frase SET audioMP3 = '/media/audio/02_diablo.mp3' WHERE idCarta = '2';
UPDATE loteriadb.frase SET audioOGG = '/media/audio/06_sirena.ogg' WHERE idCarta = '6';
UPDATE loteriadb.frase SET audioMP3 = '/media/audio/06_sirena.mp3' WHERE idCarta = '6';