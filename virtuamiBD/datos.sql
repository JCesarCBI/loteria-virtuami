...
INSERT INTO loteriadb.trofeo (nombre, imagen, imagenIcon, condicion, descripcion, idTipoTrofeo) VALUES ('Gigante en el recreo','','','Alcancé 1000 puntos en una partida de la modalidad Juego Libre en el nivel Básico','Vine, vi, conquisté',1);
...
INSERT INTO loteriadb.trofeo (nombre, imagen, imagenIcon, condicion, descripcion, idTipoTrofeo) VALUES ('Experto de la lotería','','','Acumulé 50 partidas ganadas','Bodas de oro',2);
INSERT INTO loteriadb.trofeo (nombre, imagen, imagenIcon, condicion, descripcion, idTipoTrofeo) VALUES ('Maestro de la lotería','','','Acumulé 75 partidas ganadas','Ningún misterio se me escapa',2);
