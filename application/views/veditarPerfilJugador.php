	...
	<body>						
		...
		<div id="cajaMadre" class="twelve columns">
			<div id="cajaHija" class="twelve columns">
				...
				<ul class="offset-by-four navegacion">
					<li id="" class="three column">Juego</li>
					<li id="nav-informacion" class="three column">Información</li>
					<li id="nav-estadistica"class="three column">Estadísticas</li>
					<li id="nav-galeria" class="three column">Galería</li>
				</ul>
				
				<div id="informacion" class="twelve columns informacion">
					<div id="foto-nombreUsr" class="twelve columns">
						<img class="two columns foto" src="<?= base_url() ?><?= $avatar ?>" title=""/>
					...
					<form class="columns twelve" id="cjInformacion" action="<?=base_url()?>index.php/cDatosPerfil2/editaInformacionUsuario" method="post">
						...
						<div id="c1" class="four columns">
							<center id="guardaCambios"> 
								...
								<input class="six columns centered" type="submit" id="BtnGuardaCambios" value="Guardar cambios">
							</center>
						</div>
